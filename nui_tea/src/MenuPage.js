...
function MenuPage() {
    ...
    return (
        <div className="menu-page" style={{ minHeight: '100vh', background: '#fdf6ea' }}>
            ...
            <div className="menu-container" style={{ maxWidth: 1400, margin: '0 auto', padding: '40px 0', display: 'flex', gap: 40 }}>
                {/* Sidebar danh mục */}
                ...
                <main style={{ flex: 1, minWidth: 0, paddingTop: 50 }}>
                    <div className="search-container" style={{ display: 'flex', alignItems: 'center', gap: 18, marginBottom: 36 }}>
                        <input
                            type="text"
                            value={search}
                            ...
                            <div className="products-grid" style={{
                                ...
                                {prods.map(product => (
                                    ...
                                    >
                                        ...
                                        <div className="product-name" style={{ fontWeight: 800, fontSize: 20, color: '#7c4d03', textAlign: 'center', marginBottom: 8 }}>{product.name}</div>
                                        <div className="product-description" style={{ color: '#666', fontSize: 14, textAlign: 'center', marginBottom: 8, lineHeight: 1.4, minHeight: 40 }}>{product.description}</div>
                                        <div className="product-price" style={{ color: '#b8860b', fontWeight: 800, fontSize: 18, marginBottom: 12 }}>{product.price?.toLocaleString()}đ</div>
                                        <button
