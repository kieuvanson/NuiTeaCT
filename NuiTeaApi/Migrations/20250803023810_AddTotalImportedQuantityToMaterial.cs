...
{
    /// <inheritdoc />
    public partial class AddTotalImportedQuantityToMaterial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalImportedQuantity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethod = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PaymentStatusString = table.Column<string>(type: "varchar(20)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OrderStatusString = table.Column<string>(type: "varchar(20)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Coupons",
                columns: new[] { "Id", "Code", "Description", "DiscountType", "DiscountValue", "ExpiryDate", "IsActive" },
                values: new object[,]
                {
                    { 1, "SUMMER10", "Giảm 10% cho đơn từ 100K", "percent", 10.0, new DateTime(2025, 8, 13, 9, 38, 9, 670, DateTimeKind.Local).AddTicks(23), true },
                    { 2, "MATCHA3", "Mua 2 tặng 1 cho matcha", "amount", 20000.0, new DateTime(2025, 8, 8, 9, 38, 9, 670, DateTimeKind.Local).AddTicks(51), true }
                });
